...
% clear act
arduinoObj = serialport("COM3",11520); %%read objectno
...
plot_size=700; %%number of samples in a plot
...
if(temptime_buffer>src.UserData.timelim_filt)
    emg_filtered=highpass(src.UserData.DataBuffer,4,src.UserData.fs); %filter the buffer
